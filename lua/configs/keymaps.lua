...
-- Toggle fold. Do not map <Tab>: in the terminal <Tab> and <C-i> are the
-- same key, so mapping <Tab> breaks jumplist forward (<C-i> after <C-o>).
vim.keymap.set("n", "<leader><Tab>", "za", { noremap = true, silent = true, desc = "Toggle fold" })
